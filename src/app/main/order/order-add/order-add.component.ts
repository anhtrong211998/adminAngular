...
public creatPrice(id : any){
  if(id != ""){
    this._dataService.get('/api/product/detail/' + id.toString()).subscribe((response: any) => {
      console.log(response);
      this.price = response.Price - response.PromotionPrice;
      this.detailEntity.Price = this.price;
